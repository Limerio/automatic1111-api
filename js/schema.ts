...
export interface paths {
  ...
  "/sdapi/v1/sd-vae": {
    /** Get Sd Vaes */
    get: operations["get_sd_vaes_sdapi_v1_sd_vae_get"];
  };
  ...
  "/controlnet/version": {
    /** Version */
    get: operations["version_controlnet_version_get"];
  };
  ...
  "/controlnet/settings": {
    /** Settings */
    get: operations["settings_controlnet_settings_get"];
  };
  "/controlnet/detect": {
    /** Detect */
...
export interface components {
  schemas: {
    ...
    Flags: {
       ...
       * @default D:\Documents\stable-diffusion-webui
       */
      data_dir?: string;
      /**
       * Config
       * @description path to config which constructs model
       * @default D:\Documents\stable-diffusion-webui\configs\v1-inference.yaml
       */
      config?: string;
      /**
       * Ckpt
       ...
       * @default D:\Documents\stable-diffusion-webui\model.ckpt
       */
      ckpt?: string;
      /**
       * Ckpt Dir
       ...
       * @default D:\Documents\stable-diffusion-webui\embeddings
       */
      embeddings_dir?: string;
      /**
       * Textual Inversion Templates Dir
       * @description directory with textual inversion templates
       * @default D:\Documents\stable-diffusion-webui\textual_inversion_templates
       */
      textual_inversion_templates_dir?: string;
      /**
       * Hypernetwork Dir
       * @description hypernetwork directory
       * @default D:\Documents\stable-diffusion-webui\models\hypernetworks
       */
      hypernetwork_dir?: string;
      /**
       * Localizations Dir
       * @description localizations directory
       * @default D:\Documents\stable-diffusion-webui\localizations
       */
       ...
       * @default D:\Documents\stable-diffusion-webui\ui-config.json
       */
       ...
       * @default D:\Documents\stable-diffusion-webui\config.json
       */
       ...
       * @default D:\Documents\stable-diffusion-webui\styles.csv
       */
      styles_file?: string;
      /**
       * Autolaunch
...
export interface operations {
  ...
  get_sd_vaes_sdapi_v1_sd_vae_get: {
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["SDVaeItem"][];
        };
      };
    };
  };
